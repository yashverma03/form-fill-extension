...
export const ANSWERS_DATA: Record<QuestionIdEnum, string> = {
  ...
  [QuestionIdEnum.CurrentlyBasedAtAdvertisedLocation]: 'Yes',
  [QuestionIdEnum.EmploymentType]: 'Full-time',
  [QuestionIdEnum.WillingToTravel]: 'Yes',
  [QuestionIdEnum.WillingToTravelToUSForTraining]: 'Yes',
  [QuestionIdEnum.WorkShift]: 'Day',
  [QuestionIdEnum.WillingToWorkFromOffice]: 'Yes',
  [QuestionIdEnum.PursuingFurtherEducation]: 'No',
  [QuestionIdEnum.ApplyingForInternshipOrCoOp]: 'No',
  [QuestionIdEnum.ApplyingForFullTime]: 'Yes',
  ...
  [QuestionIdEnum.FiduciaryAppointment]: 'No',
  [QuestionIdEnum.BoardOrCommitteeMembership]: 'No',
  [QuestionIdEnum.OwnershipInterestInBusiness]: 'No',
  [QuestionIdEnum.PositionOfControlInBusiness]: 'No',
  [QuestionIdEnum.GovernmentOrPoliticalInvolvement]: 'No',
  [QuestionIdEnum.AuditorEmployment]: 'No',
  ...
  [QuestionIdEnum.RegulatoryInvestigationOrDiscipline]: 'No',
  [QuestionIdEnum.DismissedForMisconduct]: 'No',
  [QuestionIdEnum.ContinueApplicationConsent]: 'Yes',
